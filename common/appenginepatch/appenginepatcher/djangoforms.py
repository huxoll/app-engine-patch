#!/usr/bin/env python
#
# Modified version of djangoforms from the GAE SDK.
#
...
This was originally packaged with the GAE SDK as djangoforms, but support was
dropped as part of the Python 2.7 support.  This module has been incorporated
into app-engine-patch to allow our django to continue to run on GAE under
Python 2.7.
